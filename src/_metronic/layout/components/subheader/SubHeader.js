...
export function SubHeader() {
  ...
  return (
    ...
    >
      ...
      >
        {/* Info */}
        <div className="d-flex align-items-center flex-wrap mr-1" style={{fontSize: 14, fontWeight: 700 }}>
          ...
          {
            !!subheader.title && <div className="d-flex align-items-baseline mr-1">
              <p className="text-dark my-2 mr-1">
                <>
                  {subheader.title}
                </>
              </p>
          ...
          <BreadCrumbs items={subheader.breadcrumbs} title={subheader.title} />
        </div>


        {/* Toolbar */}
        <div className="d-flex align-items-center">
          {subheader.toolBar[location.pathname]}
