        ...
        <div className="card-body pt-0 pb-3">
          <div className="tab-content">
            ...
            <div className="table-responsive">
              <table className="table product-list table-head-custom table-vertical-center table-head-bg table-borderless">
                <thead>
                  <tr className="text-left">
                    <th style={{ minWidth: "250px" }} className="pl-7">
                      <span className="text-dark-75">products</span>
                    </th>
                    <th style={{ minWidth: "120px", fontSize: '14px' }}>earnings</th>
                    <th style={{ minWidth: "100px", fontSize: '14px' }}>comission</th>
                    <th style={{ minWidth: "100px" , fontSize: '14px'}}>company</th>
                    <th style={{ minWidth: "100px", fontSize: '14px' }}>rating</th>
