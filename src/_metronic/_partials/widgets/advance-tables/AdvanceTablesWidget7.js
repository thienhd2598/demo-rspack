        ...
        <div className={`tab-content mt-5`} id="myTabTables12">
          ...
          >
            <div className="table-responsive">
              <table className="table product-list table-borderless table-vertical-center">
                <thead>
                  <tr>
                    <th className="p-0" style={{ width: "50px", fontSize: '14px' }} />
                    <th className="p-0" style={{ minWidth: "200px", fontSize: '14px' }} />
                    <th className="p-0" style={{ minWidth: "100px", fontSize: '14px' }} />
                    <th className="p-0" style={{ minWidth: "125px", fontSize: '14px' }} />
                    <th className="p-0" style={{ minWidth: "110px", fontSize: '14px' }} />
                    <th className="p-0" style={{ minWidth: "150px", fontSize: '14px' }} />
                  </tr>
                </thead>
                <tbody>
                  <tr>
          ...
          >
            <div className="table-responsive">
              <table className="table product-list table-borderless table-vertical-center">
                <thead>
                  <tr>
                    <th style={{ fontSize: '14px'}} className="p-0 w-50px"></th>
                    <th style={{ fontSize: '14px'}} className="p-0 min-w-200px"></th>
                    <th style={{ fontSize: '14px'}} className="p-0 min-w-120px"></th>
                    <th style={{ fontSize: '14px'}} className="p-0 min-w-120px"></th>
                    <th style={{ fontSize: '14px'}} className="p-0 min-w-120px"></th>
                    <th style={{ fontSize: '14px'}} className="p-0 min-w-160px"></th>
                  </tr>
                </thead>
                <tbody>
                  <tr>
