    ...
    <div className={`card card-custom ${className}`}>
      ...
      <div className="card-body py-0">
        ...
        <div className="table-responsive">
          <table
            className="table product-list table-head-custom table-vertical-center"
            id="kt_advance_table_widget_1"
          >
            <thead>
              <tr className="text-left">
                <th className="pl-0" style={{ width: "20px", fontSize: '14px' }}>
                  <label className="checkbox checkbox-lg checkbox-single">
                    <input type="checkbox" value="1" />
                    <span></span>
                  </label>
                </th>
                <th className="pr-0" style={{ width: "50px", fontSize: '14px' }}>
                  authors
                </th>
                <th style={{ minWidth: "200px", fontSize: '14px' }} />
                <th style={{ minWidth: "150px", fontSize: '14px' }}>company</th>
                <th style={{ minWidth: "150px", fontSize: '14px' }}>progress</th>
                <th className="pr-0 text-right" style={{ minWidth: "150px", fontSize: '14px' }}>
                  action
                </th>
              </tr>
            </thead>
