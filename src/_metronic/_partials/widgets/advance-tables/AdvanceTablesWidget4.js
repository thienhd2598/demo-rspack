        ...
        <div className="card-body pt-0 pb-3">
          <div className="tab-content">
            <div className="table-responsive">
              <table className="table product-list table-head-custom table-head-bg table-borderless table-vertical-center">
                <thead>
                <tr className="text-left text-uppercase">
                  <th className="pl-7" style={{minWidth: "250px"}}><span className="text-dark-75">products</span></th>
                  <th style={{minWidth: "100px", fontSize: '14px'}}>earnings</th>
                  <th style={{minWidth: "100px", fontSize: '14px'}}></th>
                  <th style={{minWidth: "100px", fontSize: '14px'}}>company</th>
                  <th style={{minWidth: "130px", fontSize: '14px'}}>rating</th>
                  <th style={{minWidth: "80px", fontSize: '14px'}}/>
                </tr>
                </thead>
                <tbody>
                <tr>
