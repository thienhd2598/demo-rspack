        ...
        <div className="card-body pt-2 pb-0">
          ...
          <div className="table-responsive">
            <table className="table product-list table-borderless table-vertical-center">
              <thead>
                <tr>
                  <th className="p-0" style={{ width: "50px", fontSize: '14px' }}></th>
                  <th className="p-0" style={{ minWidth: "150px", fontSize: '14px' }}></th>
                  <th className="p-0" style={{ minWidth: "140px", fontSize: '14px' }}></th>
                  <th className="p-0" style={{ minWidth: "120px", fontSize: '14px' }}></th>
                  <th className="p-0" style={{ minWidth: "40px", fontSize: '14px' }}></th>
                </tr>
              </thead>
              <tbody>
                <tr>
