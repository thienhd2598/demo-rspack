            ...
            <table className="table product-list table-borderless table-vertical-center">
              <thead>
                <tr>
                  ...
                  <th className="p-0" style={{ minWidth: "120px", fontSize: '14px' }} />
                  <th className="p-0" style={{ minWidth: "70px", fontSize: '14px' }} />
                  <th className="p-0" style={{ minWidth: "70px", fontSize: '14px' }} />
                  <th className="p-0" style={{ minWidth: "50px", fontSize: '14px' }} />
                </tr>
              </thead>
              <tbody>
                <tr>
