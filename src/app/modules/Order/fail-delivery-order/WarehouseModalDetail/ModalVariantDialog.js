...
const ModalVariantDialog = memo(
  ({
    ...
    } = useQuery(query_sme_catalog_product_variant, {
      variables: {
        limit,
        offset: (page - 1) * limit,
        order_by: {
    ...
    let totalRecord =
      dataProductVariant?.sme_catalog_product_variant_aggregate?.aggregate
        ?.count || 0;
                ...
                <div className="form-group mb-0">
                  ...
                  <div style={{ margin: "0rem 2rem 1rem 2rem" }}>
                    ...
                    <div className="d-flex mt-4">
                      <span className="mr-2" style={{ minWidth: 135 }}>
                      {formatMessage({defaultMessage: 'Tìm kiếm nhanh theo'})}:
                      </span>
                      <div
                        className="d-flex flex-column text-primary cursor-pointer"
                        style={{ fontSize: 14 }}
                      >
                        <span
                          onClick={() => {
                  ...
                  <span
                    className=""
                    style={{ margin: "0rem 2rem 1rem 2rem", fontSize: 14 }}
                  >
                    {formatMessage({defaultMessage: 'Gợi ý hàng hoá kho'})}
                  </span>
                  <div
                    style={{
                      maxHeight: 400,
                  ...
                  >
                    ...
                    {(
                      dataProductVariant?.sme_catalog_product_variant || []
                    ).map((_item, index) => {
                      let __assets =
                        _item.sme_catalog_product_variant_assets[0];
                              ...
                              >
                                ...
                                <div className="d-flex flex-column">
                                  <span
                                    ...
                                    style={{ fontSize: 14 }}
                                  >
                                    {_item?.sme_catalog_product?.name || ""}
                                    {_item?.is_combo == 1 && (
                                      <span
                                        onClick={() =>
                                          setDataCombo(_item.combo_items)
                                        }
                  ...
                  >
                    <Pagination
                      ...
                      count={
                        dataProductVariant?.sme_catalog_product_variant?.length
                      }
...
export default ModalVariantDialog;