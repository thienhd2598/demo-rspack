...
import { STATUS_ORDER, STATUS_ORDER_RETURN_EXPORT } from "./OrderReturnStatus"
...
function ExportDialog({ show, onHide, params }) {
  ...
  const _whereCondition = useMemo(() => {
    ...
    console.log(dayjs(valueRangeTime[1]).endOf('day').unix(), 2222222222)
      ...
      <Modal.Body className="overlay overlay-block cursor-default" >
        ...
        <div className="col-12" >
          ...
          <div className="row mt-3 display-flex align-items-center " >
            ...
            <div className="col-8" >
              <Select options={STATUS_ORDER_RETURN_EXPORT}
                className='w-100'
                placeholder={formatMessage({ defaultMessage: 'Tất cả' })}
                isClearable
                isMulti
