...
export default memo(({
    ...
    const view = (
        <div className="image-input mr-4 overlay" id="kt_image_4" style={{
            width: isSmall ? 66 : (isMedium ? 80 : 122), height: isSmall ? 66 : (isMedium ? 80 : 122),
        ...
        >
            ...
            }
            {
                !!source && <div className="image-input-wrapper" style={{
                    ...
                    ...(isSmall ? { width: 66, height: 66 } : (isMedium ? { width: 66, height: 66 } : {}))
                }}></div>
            }
            {
                !!preview && !source && <img className="image-input-wrapper" style={isSmall ? { width: 66, height: 66 } : (isMedium ? { width: 66, height: 66 } : {})} src={preview} />
            }
