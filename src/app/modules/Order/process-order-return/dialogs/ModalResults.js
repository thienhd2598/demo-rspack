...
export const ModalImportResult = ({ onHide, resultImportWarehouse }) => {
  ...
  return (
    ...
    >
      <Modal.Header>
        <Modal.Title>
          {formatMessage({ defaultMessage: "Kết quả xử lý đơn hoàn" })}
        </Modal.Title>
        <span>
          <i
      ...
      <Modal.Body className="overlay overlay-block cursor-default">
        <div className="row">
          <div className="col-12 mt-3">
            {formatMessage({ defaultMessage: "Tổng đơn hoàn cần xử lý" })}:{" "}
          ...
          <div className="col-12 mt-3">
            {formatMessage({
              defaultMessage: "Tổng đơn hoàn xử lý thành công",
            })}
            :{" "}
          ...
          <div className="col-12 mt-3">
            {formatMessage({
              defaultMessage: "Tổng đơn hoàn xử lý thất bại",
            })}
            :{" "}
                  ...
                  >
                    <tr className="font-size-lg">
                      <th style={{ fontSize: "14px" }} width="50%">
                        {formatMessage({ defaultMessage: "Mã vận đơn hoàn" })}
                      </th>
  ...
  return (
    ...
    >
      ...
      <Modal.Body className="overlay overlay-block cursor-default">
        <div className="row">
          <div className="col-12 mt-3">
            {formatMessage({ defaultMessage: "Tổng mã vận đơn hoàn tải lên" })}:{" "}
            <span className="font-weight-bold">
              <strong>
          ...
          <div className="col-12 mt-3">
            {formatMessage({
              defaultMessage: "Tổng mã vận đơn hoàn tải lên hợp lệ",
            })}
            :{" "}
            <span className="font-weight-bold text-success">
          ...
          <div className="col-12 mt-3">
            {formatMessage({
              defaultMessage: "Tổng mã vận đơn hoàn tải lên thất bại",
            })}
            :{" "}
            <span className="font-weight-bold text-danger">
