...
const ModalNote = ({ state, show, updateState }) => {
  ...
  const SignupSchema = Yup.object().shape({
    note: Yup.string()
      ...
      .max(
        255,
        formatMessage({ defaultMessage: "Ghi chú nhập tối đa 255 ký tự" })
      ),
              ...
              <Modal.Body>
                ...
                >
                  ...
                  >
                    ...
                    >
                      {formatMessage({ defaultMessage: "Video" })}:
                    </span>
                    <div className="d-flex flex-wrap flex-gap-2">
                    {
                    ...
                    {
                      productVideFiles.length < 1 && <VideoUpload customeStyle={{width: 66, height: 66}} accept={".mp4"}
