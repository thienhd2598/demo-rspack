...
import { STATUS_ORDER_PACK, STATUS_PACK_TAB } from '../OrderUIHelpers';
import { Checkbox } from '../../../../_metronic/_partials/controls';
import SVG from "react-inlinesvg";
import duration from 'dayjs/plugin/duration';
import { TooltipWrapper } from '../../Finance/payment-reconciliation/common/TooltipWrapper'
import OrderProductRow from '../order-list/OrderProductRow';
...
export default memo(({
    onSetSmeNote, params, order: orderPack, key,
        ...
        return (
            <div>
                ...
                <div className='d-flex mt-2'>
                    ...
                    {(16 & orderPack?.print_status) == 16 && <OverlayTrigger overlay={<Tooltip>{formatMessage({ defaultMessage: 'Đã in phiếu nhặt hàng' })}</Tooltip>}>
                ...
                <td colSpan='7' className='p-0'>
                    <div className='d-flex align-items-center justify-content-between' style={{ background: '#D9D9D9', padding: '8px' }}>
                        <div className='d-flex'>
                            ...
                            <span style={{ cursor: 'pointer' }} onClick={() => window.open(`/orders/${orderPack?.order?.id}`, "_blank")}>
