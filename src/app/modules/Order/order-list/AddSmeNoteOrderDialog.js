...
const AddSmeNoteOrderDialog = ({ dataSmeNote, onHide }) => {
            ...
            >
              ...
              <Modal.Body>
                <div>
                  ...
                  {Array.isArray(dataSmeNote?.id) && <div className='mb-2 bold'>Số lượng kiện hàng đã chọn: {dataSmeNote?.id?.length}</div>}
                    ...
                    <div className="col-12">
                      <Field name={`smeNote`}
                        ...
                        placeholder={formatMessage({
                          defaultMessage: "Nhập ghi chú người bán",
                        })}
                        label={""}
                        required={false}
                        customFeedbackLabel={" "}
...
export default AddSmeNoteOrderDialog