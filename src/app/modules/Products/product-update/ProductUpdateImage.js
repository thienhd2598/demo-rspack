...
const ProductUpdateImage = () => {
    ...
    suhbeader.setTitle('Sửa ảnh sản phẩm kho');
                ...
                return (
                    <Fragment>
                        <RouterPrompt
                            // when={changed}                        
                            when={false}
                            title={formatMessage({defaultMessage:"Bạn đang cập nhật ảnh sản phẩm kho. Mọi thông tin bạn nhập trước đó sẽ bị xoá nếu bạn thoát màn hình này. Bạn có chắc chắn muốn thoát?"})}
                        ...
                        <Form>
                            <Card>
                                <CardBody>
                                    ...
                                    >
                                        <table className="table table-borderless  fixed" style={{ tableLayout: 'fixed', borderCollapse: 'collapse', position: 'relative' }}>
                                                            ...
                                                            <div className="d-flex flex-row">
                                                                ...
                                                                <div>
                                                                    ...
                                                                    <div style={{ display: 'flex', alignItems: 'center' }} >
                                                                        <p className="d-flex" ><img src={toAbsoluteUrl('/media/ic_sku.svg')} />
