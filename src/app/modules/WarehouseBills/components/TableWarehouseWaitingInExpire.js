...
import WarehouseBillInExpireRow from "./WarehouseBillInExpireRow";
        ...
        () => {
            return (
                <tr className="text-left" >
                    ...
                    <th style={{ fontSize: '14px' }} width='8%' className="text-center">
                    ...
                    <th style={{ fontSize: '14px' }} className="text-center" width='16%'>
                            ...
                            <tbody>
                                ...
                                )}
                                {
                                    !error && !loading && data?.warehouse_bill_items?.map(_wareHouseBill => {                                       
                                        return <WarehouseBillInExpireRow _wareHouseBill={_wareHouseBill} setDataCombo={setDataCombo}/>
                                    })
                                }
                            </tbody>
                        </table>
