...
const STATUS_PACKAGES = ['ready_to_ship', 'packing','packed', 'shipping', 'shipped', 'completed', 'cancelled']
...
const STATUS_SALES_ORDER_FILTER = [
  {
...
const OPTIONS_SEARCH_BY_TIME = [
  ...
  const FILE_IMPORT_MENUAL_STAG = "https://prod-statics.s3.ap-southeast-1.amazonaws.com/template/Stagging/format_import_tao_don_thu_cong.xlsx"
  const FILE_IMPORT_MENUAL_PROD = "https://prod-statics.s3.ap-southeast-1.amazonaws.com/template/prod/format_import_tao_don_thu_cong.xlsx"
