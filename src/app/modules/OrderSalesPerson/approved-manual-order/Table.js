...
const Table = memo(({ 
    onApprovedManualOrder, onSetDataSmeNote, setDataSmeNote, 
    onOpenConfirmDialog, dataSmeVariant, 
    setDataSelectedOrder, dataSelectedOrder, limit, page, dataTable }) => {
        ...
        <div style={{ boxShadow: "inset -1px 0px 0px #D9D9D9, inset 1px 0px 0px #D9D9D9, inset 0px 1px 0px #D9D9D9, inset 0px -1px 0px #D9D9D9", borderBottomLeftRadius: 6, borderBottomRightRadius: 6, borderTopRightRadius: 6,minHeight: 300}}>
            ...
            {!error && (
                <Pagination
                    ...
                    basePath={'/order-sales-person/approved-order'}
