...
const ModalReceiver = ({
    ...
    const { optionsProvince, optionsDistrict } = useOrderPosContext();
        ...
        <Fragment>
            ...
            >
                <Modal.Header closeButton={true}>
                    <Modal.Title>
                        {formatMessage({ defaultMessage: 'Chọn thông tin khách hàng' })}
                    </Modal.Title>
                </Modal.Header>
                        ...
                        <div style={{ position: 'relative' }}>
                            ...
                            <Table
                                ...
                                emptyText={<div className='d-flex flex-column align-items-center justify-content-center my-10'>
                                    ...
                                    <span className='mt-4'>
                                        {formatMessage({ defaultMessage: 'Chưa có thông tin khách hàng' })}
                                    </span>
                                </div>}
                                tableLayout="auto"
                                scroll={{ y: 350 }}
