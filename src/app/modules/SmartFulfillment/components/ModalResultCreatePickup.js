...
const ModalResultCreatePickup = ({ onHide, result }) => {
    ...
    return (
        ...
        >
            <Modal.Header>
                <Modal.Title>
                    {formatMessage({ defaultMessage: "Kết quả tạo phiếu nhặt hàng" })}
                </Modal.Title>
                <span>
                    <i
            ...
            <Modal.Body className="overlay overlay-block cursor-default py-1">
                <div className="row">
                    <div className="col-12 mt-3">
                        <span>{formatMessage({ defaultMessage: "Kiện hàng cần đã chọn" })}:</span>
                    ...
                    <div className="col-12 mt-3">
                        <span>{formatMessage({ defaultMessage: "Số phiếu được tạo" })}:</span>
                        <span className="font-weight-bold text-success ml-2">
                            {result?.total_session_pickup}
                        </span>
                    </div>
                    <div className="col-12 mt-3">
                                            ...
                                            .map((err, i) => (
                                                <tr key={i}>
                                                    <td>
                                                        ...
                                                        >
                                                            <span className='ml-2'>
                                                                <i style={{ cursor: 'pointer', color: '#0D6EFD' }} onClick={() => onCopyToClipBoard(err?.system_package_number)} className="far fa-copy"></i>
                                                            </span>
                                                        </OverlayTrigger>
                                                    </td>
