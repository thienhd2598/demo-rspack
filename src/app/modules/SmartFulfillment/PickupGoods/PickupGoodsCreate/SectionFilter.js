...
import { OPTIONS_FILTER_PICKUP, OPTIONS_PROCESSING_DEADLINE, OPTIONS_TYPE_PARCEL } from "../../SmartFulfillmentHelper";
...
const SectionFilter = () => {
    ...
    const { setIds, setIsLoadPackages, setIsInitLoadPackages, filtersPackage, setFiltersPackage, optionsSmeWarehouse, optionsChannel, optionsStore, optionsShippingUnit } = usePickupGoodsContext();
                            ...
                            <div className="mb-4 px-4 py-2" style={{ border: '1px solid rgb(235, 237, 243)', borderRadius: 20 }}>
                                <div className="row d-flex align-items-center">
                                    ...
                                    <div className="col-7 pl-0">
                                        ...
                                        />}
                                        {/* Lọc theo mã đơn hàng || mã vận đơn */}
                                        {(item?.type == 'ref_order_id' || item?.type == 'tracking_number') && <div
                                        ...
                                        {(item?.type == 'store' || item?.type == 'channel' || item?.type == 'shipping_unit' || item?.type == 'processing_deadline' || item?.type == 'type_parcel')
                                            && <Select
                                                value={item?.value}
                                        ...
                                        {item?.type == 'range_time' && <DateRangePicker
