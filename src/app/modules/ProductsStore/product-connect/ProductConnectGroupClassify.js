                                        ...
                                        dataAttribute.scAttr
                                            ?.map(_option => {
                                                return <label key={`_option--${_option?.value}`} className="radio" style={{ marginBottom: '2rem', paddingRight: '4rem' }}>
                                                    <input type="radio" name="radios3" value={_option?.value} checked={_option?.value == valueSc} />
                                                    <span></span>
                                                    {_option?.label}
                                                </label>
                                            })
                                ...
                                >
                                    {
                                        dataAttribute.smeAttr
                                            ?.map(_option => {
                                                return <label key={`_option--${_option?.value}`} className="radio" style={{ marginBottom: '2rem', paddingRight: '4rem' }}>
                                                    <input type="radio" name="radios4" value={_option?.value} checked={_option?.value == valueSme} />
                                                    <span></span>
                                                    {_option?.label}
                                                </label>
                                            })
