...
const DeleteProductConnectDialog = memo(({
    ...
    sc_variant_id,
    setDataInventories,
    setSmeCatalogProductVariantByPk,
    setSmeCatalogProductByPk,
}) => {
            ...
            switch (action) {
                ...
                case 'unlink_product_variant':
                    ...
                    if (resVariant?.data?.scUnLinkSmeProductVariantToConnector?.success) {
                        onHide();
                        !!setDataInventories && setDataInventories(null)
                        !!setSmeCatalogProductVariantByPk && setSmeCatalogProductVariantByPk(null)
        ...
        >
            <Modal.Body className="overlay overlay-block cursor-default text-center">
                ...
                }
                {
                    !loading && !error && (
                        <>
                            <div className="mb-4" >{formatMessage({ defaultMessage: 'Bạn có chắc muốn huỷ liên kết sản phẩm này không?' })}</div>
