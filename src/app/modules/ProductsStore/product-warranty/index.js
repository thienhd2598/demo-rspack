...
function ProductWarranty(props) {
  ...
  return (
    <Card>
      <CardHeader title={intl.formatMessage({ defaultMessage: "BẢO HÀNH" })}>
      </CardHeader>
      <CardBody>
        <div className='row' >
          <div className='col-6' >
            <Field
              name={'warranty_type'}
              component={ReSelect}
              placeholder={intl.formatMessage({ defaultMessage: 'Chọn loại bảo hành' })}
              label={intl.formatMessage({ defaultMessage: 'Loại bảo hành' })}
              customFeedbackLabel={' '}
          ...
          <div className='col-6' >
            <Field
              name={'warranty_time'}
              component={ReSelect}
              placeholder={intl.formatMessage({ defaultMessage: 'Chọn thời gian bảo hành' })}
              label={intl.formatMessage({ defaultMessage: 'Thời gian bảo hành' })}
              customFeedbackLabel={' '}
          ...
          <div className='col-12' >
            <Field
              ...
              label={intl.formatMessage({ defaultMessage: 'Chính sách Bảo hành' })}
              customFeedbackLabel={' '}
              required={false}
              countChar
              absolute
