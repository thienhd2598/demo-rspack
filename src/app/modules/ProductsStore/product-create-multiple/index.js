...
const ProductCreateMultiple = () => {
    ...
    useEffect(() => {
        setBreadcrumbs([
            {
                title: formatMessage({ defaultMessage: 'Tạo sản phẩm kho hàng loạt' }),
    ...
    const initialValues = useMemo(
        () => {
            const { products: productsLocation } = history?.location?.state || {};

            setProducts(productsLocation || []);
            ...
            (productsLocation || []).forEach(product => {
                const sortAttribute = [...product?.productVariantAttributes]
                ...
                <CardBody style={{ padding: '1rem' }} >
                    <Formik
                        ...
                        onSubmit={async (values) => {
                            ...
                            console.log({ res, body, product: history?.location?.state?.products });

                            setDataResult(res?.data?.scProductSyncDown);
                        }}
                    >
                        {({
                            values,
                                    ...
                                    <table className="table table-borderless product-list table-vertical-center fixed">
                                        ...
                                        >
                                            <tr className="font-size-lg" style={{ zIndex: 1, borderRadius: 6 }}>
                                                ...
                                                <th className='text-center' style={{ fontSize: '14px' }} width="6%">
...
export default ProductCreateMultiple;