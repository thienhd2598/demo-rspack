...
const ProductCreateFrameImg = memo(({
    ...
    const [isApplyCover, setIsApplyCover] = useState(false);
                    ...
                    <>
                        ...
                        {/* <div className="m-4 d-flex justify-content-between align-items-center">
                            <div className='d-flex'>
                                ...
                                >
                                    {optionApplyCover?.map(
                                        (_option, index) => (
                                            <label key={`option-${index}`} className="radio mb-4">
                                                <input
                                                    type="radio"
                                                    value={_option.value}
                                                    checked={selectedApplyCover == _option.value}
                                                />
                                                <span></span>
                                                {_option?.title}
                                            </label>
                                                ...
                                                data?.sme_catalog_photo_frames?.map(
                                                    (item, index) => (
                                                        <div
                                                            ...
                                                            style={{ flexDirection: 'column', maxWidth: 77 }}
                                                        >
                                                            <div
                                                                key={`catalog-frame-img-${index}`}
                                                                className="mb-1"
                                                                style={{ position: 'relative', border: currentFrameUrl == item?.asset_url ? '1px solid #ff5629' : '', borderRadius: 4 }}
                                                                onClick={() => {
                                                            ...
                                                            >
                                                                <img
                                                                    ...
                                                                    src={item?.asset_url}
                                                                />
                                                                {currentFrameUrl == item?.asset_url && (
                                                                    <i
                        ...
                        <div>
                            <Pagination
                                ...
                                emptyTitle={formatMessage({defaultMessage:'Chưa có khung ảnh nào'})}
                            />
                        </div>
