...
import { DATE_TYPE_OPTIONS, ORDER_TYPE_OPTIONS, COMPARE_TYPE_OPTIONS, STATUS_ORDER } from '../TradingReportHelper';
import _ from 'lodash';
import dayjs from 'dayjs';
import { saveAs } from 'file-saver';
import { useElementOnScreen } from '../../../../../hooks/useElementOnScreen';
import clsx from 'clsx';
import mutate_CfExportOverviewFinanceReport from '../../../../../graphql/mutate_ cfExportOverviewFinanceReport';
...
const TradingReportOverviewFilter = ({ currentChannel, channelsActive, loadingChannels, variables }) => {
    ...
    const [cfExportOverviewFinanceReport, { loading: loadingCfExportOverviewFinanceReport }] = useMutation(mutate_CfExportOverviewFinanceReport);
    ...
    const onExportOverviewFinanceReport = useCallback(async () => {
        try {
            const { data } = await cfExportOverviewFinanceReport({
                variables
            });

            if (!!data?.cfExportOverviewFinanceReport?.success) {
                ...
                saveAs(data?.cfExportOverviewFinanceReport?.link, nameFileExport)
