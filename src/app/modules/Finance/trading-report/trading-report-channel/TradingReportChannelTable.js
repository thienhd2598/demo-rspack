...
import query_CfGetFinancePlatformDashboardTable from '../../../../../graphql/query_CfGetFinancePlatformDashboardTable';
...
const TradingReportChannelTable = ({ onToggleDrawer, onSetCurrentKeyChart, listChannelCode, optionsStores, variables }) => {
    ...
    const { data, loading } = useQuery(query_CfGetFinancePlatformDashboardTable, {
        variables,
    ...
    const dataTabe = useMemo(() => {
        if (!data?.CfGetFinancePlatformDashboardTable) return [];

        const {
            capital_price, discount_sales, fees_platform, gross_profit,
            marketing_costs, net_revenue, operating_costs, profit,
            profit_margin, revenue_sell, amount_order, capital_price_sell,
            capital_price_gift, money_about_wallet
        } = data?.CfGetFinancePlatformDashboardTable || {};
        ...
        const table = [
            ...
            },
            {
                ...
                value: capital_price?.value ?? "--",
                ...parseDataChannel(capital_price?.group_channel),
                children: [
                    {
                        key: 'Giá vốn hàng bán',
                        code: '4.1',
                        title: 'Giá vốn hàng bán',
                        value: capital_price_sell?.value ?? "--",
                        ...parseDataChannel(capital_price_sell?.group_channel),
                    },
                    {
                        key: 'Giá vốn quà tặng',
                        code: '4.2',
                        title: 'Giá vốn quà tặng',
                        value: capital_price_gift?.value ?? "--",
                        ...parseDataChannel(capital_price_gift?.group_channel),
                    }
                ]
            },
            {
                ...
                ...parseDataChannel(gross_profit?.group_channel),
            },
            {
                key: 'fees_platform',
                code: '06',
            ...
            },
            {
                ...
                ...parseDataChannel(operating_costs?.group_channel),
