...
const ModalProductCreateFrameImg = memo(({
    show,
    setProductSelect,
    ids,
    onHide,
    ...
    const [createFrameImage, { loading: loadingCreateFrameImage }] = useMutation(mutate_scProductFrameImages, {
        refetchQueries: ['sc_composite_image_sync'],
                    ...
                    <>
                        ...
                        <div className='row py-2 px-4 d-flex align-items-center'>
                            <div className="col-5">
                                ...
                                >
                                    {optionApplyCover?.map(
                                        (_option, index) => <option key={`option-${index}`} value={_option.value}>
                                            {_option?.title}
                                        </option>
                                    )}
                                </select>
                            ...
                            <div className="col-5">
                                ...
                                >
                                    {optionApplyBgUrl?.map((_option, index) => 
                                        <option key={`option-${index}`} value={_option.value}>
                                            {_option?.title}
                                        </option>
                                    )}
                                </select>
...
export default ModalProductCreateFrameImg;